...
const ROWS: Row[] = [
  ...
  { id: 16, time: "10:00 – 11:00 PM", startMin: 1320, dur: 60, act: "AI MODEL TRAINING", focus: "Machine Learning, Prompt Engineering, LLMs", cat: "technical", icon: "🤖" },
  { id: 17, time: "11:00 – 11:30 PM", startMin: 1380, dur: 30, act: "LANGUAGE STUDY", focus: "Duolingo & Matiks", cat: "gs", icon: "🌍" },
...
const CHECKLIST_ITEMS = ["Wake Up", "Exercise", "Breakfast", "Theory Completed", "Numericals Completed", "PYQs", "Aptitude", "Revision", "AI Training", "Language Study", "Sleep Before 11:30 PM"];

const ROW_CHECKLIST_MAP: Partial<Record<number, string>> = {
  0: "Wake Up", 1: "Exercise", 3: "Breakfast", 4: "Theory Completed", 6: "Numericals Completed", 8: "PYQs", 10: "Aptitude", 15: "Revision", 16: "AI Training", 17: "Language Study", 18: "Sleep Before 11:30 PM",
};
